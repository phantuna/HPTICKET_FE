...
export const RevenueReportTab: React.FC<RevenueReportTabProps> = ({
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 bg-white p-4 rounded-md shadow-sm border border-slate-100 mb-6">
